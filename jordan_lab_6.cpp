...
// using two functions.
const int ADD = 1;   // Pass as the argument when calculating the root: -b + ...
const int SUB = -1;   // Pass as the argument when calculating the root: -b - ...
...
// end function
//------------------------------------------------------------------------------
void calc_complex_roots(double a, double b, double c, double disc, double& real, double& imaginary) {
...
//------------------------------------------------------------------------------
double calc_real_root(double a, double b, double c, double disc, double add_sub) {
	double numer;
	double denom = 2 * a;
...
int main()
{
    ...
    // Check and handle the case when disc is < 0 (two complex roots)
    	...
    	calc_complex_roots(a, b, c, disc, real, imaginary);
    	output_complex_roots(fout, real, imaginary);
    }
